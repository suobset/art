      ...
      <div className="surface-frame px-5 py-5 md:px-6 md:py-6">
        <div className="grid gap-6 md:grid-cols-[1.05fr_0.95fr_0.7fr]">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-muted)]">Visit <a href={author.blog} className="text-[var(--accent-2)] underline underline-offset-4">declarative</a>, browse <a href={author.resume} className="text-[var(--accent-2)] underline underline-offset-4">resume</a>, view <a href="https://github.com/suobset/art" className="text-[var(--accent-2)] underline underline-offset-4">source code</a>, or share the gallery from <a href={author.artDomain} className="text-[var(--accent-2)] underline underline-offset-4">art.skushagra.com</a>.</p>
          </div>
          <div>
